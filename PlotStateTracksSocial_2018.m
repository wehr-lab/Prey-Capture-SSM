function PlotStateTracksSocial_2018(outputdir)
fprintf('\n%s',mfilename)
%talapas is running matlab 2018 which doesn't have tiledlayout, so I have
%to downgrade to subplot
%
...
%             m2ry=m2y;
            ...
            %plot(m1x, m1y, 'r');
            %plot(m2x, m2y, 'b');
            subplot(611) %plot position tracks
