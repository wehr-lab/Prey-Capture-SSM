function [outputArg1,outputArg2] = tracks_to_observations(tracks)
%TRACKS_TO_OBSERVATIONS Summary of this function goes here
%   Detailed explanation goes here

% TODO - now adapt this to use tracks, 
    % make single function and then build iterator function on top of it

for sourcefilenum=1:length(tracks)
