...
talapas=contains(char(getHostName(java.net.InetAddress.getLocalHost)), 'talapas');
if talapas
    ext='avi';
else
    ext='mp4';
...
try
    ...
    for k=1:num_states
        ...
        for e=1:numepochs(k)           
            ...
            NumFrames(k,e)=ceil(vobj.FrameRate*vobj.Duration);
    ...
    case '3x3'
        ...
        for k=[1:num_states]
            ...
            for ei=1:max_num_epochs
                e=sNumFramesi(k,ei);
                in_movie_filename=fullfile(outputdir, sprintf('ssm_state_epoch_clip-%d-%d.%s', k, e, ext));
                try
...
for k=[1:num_states]
    ...
    if exist(in_movie_filename)==2
        ...
        for i=1:10
            ...
            for f=1: ceil(vin.FrameRate*vin.Duration)
                fc=fc+1;
