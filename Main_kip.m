...
%  data_filename='~/Documents/Analysis/myHHMM/kip/kip_data.mat'; 
        data_filename='~/Documents/Analysis/myHHMM/kip/kip_data1211deaf.mat'; 
        %root directory for source movies
        %local_movie_root='/Volumes/Projects/PreyCapture/A1Suppression/save';
        local_movie_root='/Volumes/Projects/PreyCapture/A1Suppression/save-deafening';
        %output directory for results and generated video clips
...
outputdir=sprintf('%s%sstate_epoch_clips-deaf-%s',outputroot, filesep, datestr(today));
%OR
...
ConvertHHMMdatasetToObservations(data_filename, outputdir)
