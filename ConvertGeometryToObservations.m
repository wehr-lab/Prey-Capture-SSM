...
%         X(startidx:startidx-1+numframes, 12)= geo.cricketacceleration;
        X(startidx:startidx-1+numframes, 5)= geo.cricket_thigmo_distance;
        X(startidx:startidx-1+numframes, 6)= geo.mouse_thigmo_distance;
...
X_description{5}='cricket_distance_from_wall';
X_description{6}='mouse_distance_from_wall';
